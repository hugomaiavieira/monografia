...
\begin{enumerate}
\item Adicionar um teste
\item Rodar todos os testes e ver se algum falha
\item Escrever código
\item Rodar os testes e ter sucesso
\item Refatorar
\end{enumerate}
...
Vejamos agora como isso se dá na prática. Eu preciso de saber todos os contribuidores de um projeto, incluindo o dono do projeto e demais contribuidores adicionais. Então, a primeira coisa a ser feita é a esta especificação para o caso mais simples. Um projeto sempre tem um dono, mas pode não ter nenhum contribuidor adicional. Assim, a especificação do caso mais simples pode ser como mostrada no código \ref{code:spec_all_contributors1}.
...
Ao rodar este teste, ele irá falhar, informando que o método \textit{all\_contributors} retorna apenas uma lista que inclui apenas seu dono. Escrevemos então o código mais simples que atenda a essa especificação:
...
% \lstinputlisting[caption=Exemplo de teste de unidade em Ruby,label=teste-de-unidade,language=Ruby]{code/teste.rb}
