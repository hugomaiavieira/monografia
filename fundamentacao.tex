...
Contudo, apesar de seguirem sentidos opostos, no desenvolvimento ágil é possível e desejável utilizar técnicas de teste de software oriundas e utilizadas no modelo tradicional, como classes de equivalência, análise do valor limite e análise da complexidade ciclomática.

Os próximos tópicos definirão quais os tipos de teste utilizadas no contexto do presente trabalho.
