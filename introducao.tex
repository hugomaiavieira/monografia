...
TODO: Adicionar trabalhos acabemicos relacionados. Citar o cara do BDD que cita rogério, e etc. Dizer que eles falam sempre muito por cima, sem entrar em detalhes de implementação (como já digo nosnobjetivos).
