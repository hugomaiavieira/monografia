...
Em seu estudo \cite{DammTDD} notou que:

\begin{citacao}
Test-Driven Development faz com que as pessoas pensem mais no design em vez de se codificar precipitadamente sem saber o que implementa ainda. (tradução do autor)
\end{citacao}
