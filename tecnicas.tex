...
\begin{listing}
  \caption{Teste para o método Project\#tasks\_by\_position (versão 1)}
  \label{code:tdd_test1}
  \begin{minted}{ruby}
...
\begin{listing}
  \caption{Código do método Project\#tasks\_by\_position (versão 1)}
  \label{code:tdd_code1}
  \begin{minted}{ruby}
...
\begin{listing}
  \caption{Teste do método Project\#tasks\_by\_position (versão 2)}
  \label{code:tdd_test2}
  \begin{minted}{ruby}
# test/unit/project_test.rb
class ProjectTest < ActiveSupport::TestCase
  def test_tasks_by_position
...
\begin{listing}
  \caption{Código do método Project\#tasks\_by\_position (versão 2)}
  \label{code:tdd_code2}
  \begin{minted}{ruby}
# app/models/project.rb
def tasks_by_position position
  task_list = []
...
\begin{listing}
  \caption{Teste do método Project\#tasks\_by\_position (versão 3)}
  \label{code:tdd_test3}
  \begin{minted}{ruby}
# test/unit/project_test.rb
class ProjectTest < ActiveSupport::TestCase
  def test_tasks_by_position
...
\begin{listing}[H]
  \caption{Código do método Project\#tasks\_by\_position (versão 3)}
  \label{code:tdd_code3}
  \begin{minted}{ruby}
# app/models/project.rb
def tasks_by_position position
