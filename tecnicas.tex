...
Em uma situação onde se está desenvolvendo uma aplicação para um cliente, é existe um mito sobre o cliente escrever as especificações, contudo está é uma abordagem utópica \cite{SteakOverCucumber}. O cliente pode até ler e validar, mas mesmo assim esta não é uma abordagem muito interessante.
...
TODO: Falar de integração contínua síncrona e assíncrona (e discutir depois no contexto do kanban-roots).
