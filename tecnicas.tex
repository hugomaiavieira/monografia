...
\citeonline{DammTDD} também afirmam que o TDD faz com que as pessoas pensem mais no design em vez de se codificar precipitadamente sem saber o que implementa ainda.
...
\subsection{Um novo modelo de escrita} % (fold)
...
% subsection um_novo_modelo_de_escrita (end)
