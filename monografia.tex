...
\usepackage{textcomp}
% \usepackage{floatrow} % tem que ser incluido antes do minted
\usepackage{minted}
...
\captionsetup[listing]{style=code_style,format=code_format,labelfont=code_font,textfont=code_font}
% http://mirror.ctan.org/macros/latex/contrib/floatrow/floatrow.pdf
