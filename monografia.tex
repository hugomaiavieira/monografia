...
\hypersetup{
  pdftitle=Métodos emergentes de teste de software,
...
% TODO: Métodos, Técnicas ou Práticas? Tem que padronizar no texto como um todo
\titulo{Métodos emergentes de teste de software}
