...
\begin{abstract}
With the rise of agile development methods in recent years, different software testing techniques are emerging to support the main feature of such methods: rapid feedback. Because they are emerging techniques of the market, there are very few academic references on the topic. This paper will discuss the main emerging techniques for software testing, addressing them in the context of an real project, aggregating knowledge, now scattered and diffuse, on different approaches, possibilities and open points in the employment of such techniques.
\end{abstract}
